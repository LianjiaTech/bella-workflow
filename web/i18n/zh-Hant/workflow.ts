const translation = {
  common: {
    ...
    copilot: '',
    copilotPanel: '智能助手',
    copilotPlaceholder: '在下方框中詢問有關工作流的問題',
    debugAndPreview: '預覽',
    restart: '重新開始',
    currentDraft: '當前草稿',
    ...
    syncingData: '正在同步數據，請稍等幾秒鐘。',
    importDSL: '導入 DSL',
    importDSLTip: '當前草稿將被覆蓋。導入前請將工作流導出作為備份。',
    backupCurrentDraft: '備份當前草稿',
    chooseDSL: '選擇 DSL(yml) 文件',
    overwriteAndImport: '覆蓋並導入',
    importFailure: '導入失敗',
    importSuccess: '導入成功',
    historyVersion: '歷史發佈版本',
    version: {
      notify: {
        cancel: '默認版本設置已取消',
      },
  ...
  env: {
    envPanelTitle: '環境變量',
    envDescription: '環境變量可用於存儲私有信息和憑據。它們是只讀的，並且可以在導出期間與 DSL 文件分開。',
    envPanelButton: '添加變量',
    modal: {
      title: '添加環境變量',
      editTitle: '編輯環境變量',
      type: '類型',
      name: '名稱',
      namePlaceholder: '環境變量名稱',
      value: '值',
      valuePlaceholder: '環境變量值',
      secretTip: '用於定義敏感信息或數據，DSL 設置配置為防止洩漏。',
    },
    export: {
      title: '導出機密環境變量？',
      checkbox: '導出機密值',
  ...
  customApi: {
    title: '自定義 API',
    desc: '自定義 API 允許您將工作流暴露為自定義域名和路徑，供外部系統調用，無需使用 tenantId 和 workflowId',
    add: '添加自定義 API',
    host: '域名',
    hostPlaceholder: '請輸入域名 host',
    path: '路徑',
    pathPlaceholder: '請輸入路徑 path',
    startFromBlank: '創建自定義 API',
    table: {
      header: {
        id: 'ID',
        host: '域名 host',
  ...
  trigger: {
    title: '觸發器',
    desc: '觸發器允許您在特定事件發生時運行工作流',
    add: '添加觸發器',
    name: '名稱',
    namePlaceholder: '請填寫觸發器名稱',
    description: '描述',
    descriptionPlaceholder: '請填寫觸發器描述',
    startFromBlank: '創建觸發器',
    captionTriggerType: '觸發器類型',
    crontab: '觸發時間',
    inputs: '工作流入參',
    inputsPlaceholder: '請填寫工作流入參',
    schdDescription: '指定工作流的執行時間',
    kafkaDescription: '從 Kafka 接收消息觸發工作流',
    expression: '觸發條件',
    datasource: '數據源',
    expressionTypeDesc: '觸發條件類型',
    toggle: {
      activate: '觸發器已激活',
      deactivate: '觸發器已停用',
    },
