...
const FileInAttachmentItem = ({
  ...
  const { _id, filename, type, progress, supportFileType, base64Url, url, isRemote } = file
  const ext = getFileExtension(filename, type, isRemote)
      ...
      <div className={cn(
        ...
        <div className='flex items-center justify-center w-12 h-12'>
          ...
          }
          {
            !isImageFile && (
              <FileTypeIcon
                type={getFileAppearanceType(filename, type)}
                size='lg'
              />
            )
          }
        ...
        <div className='shrink-0 flex items-center'>
          ...
          {
            showDeleteAction && (
              <ActionButton onClick={() => onRemove?.(_id)}>
          ...
          }
          {
            showDownloadAction && (
              <ActionButton onClick={(e) => {
                e.stopPropagation()
                downloadFile(url || base64Url || '', filename)
              }}>
