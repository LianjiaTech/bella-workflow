          ...
          <>
            ...
            >
              <Menu.Items
                className={cn(
                  `
                    absolute left-[140px] min-w-[200px] max-h-[70vh] overflow-y-scroll z-10 bg-white border-[0.5px] border-gray-200
                ...
                <div className="px-1 py-1">
                  {
                    workspaces.map(workspace => (
                      <div className={itemClassName} key={workspace.spaceCode} onClick={() => handleSwitchWorkspace(workspace.spaceCode)}>
                        ...
                        {workspace.spaceCode === spaceCode && <Check className={itemCheckClassName} />}
                      </div>
                    ))
                  }
                </div>
