...
public class Tenant extends TableImpl<TenantRecord> {
     ...
     */
    public final TableField<TenantRecord, String> OPENAPI_KEY = createField(DSL.name("openapi_key"),
            SQLDataType.VARCHAR(64).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");
