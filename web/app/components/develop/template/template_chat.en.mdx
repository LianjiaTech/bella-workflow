  ...
  <Col>
    ...
    <Properties>
      ...
      <Property name='files' type='array[object]' key='files'>
          ...
          - `id` (string) Uploaded file ID, which must be obtained by uploading through the File Upload API in advance (when the transfer method is `local_file`)
      </Property>
                ...
                "message_files": [
                    {
                        ...
                        "type": "image",
                        "url": "http://0.0.0.0:5001/files/tools/976990d2-5294-47e6-8f14-7356ba9d2d76.png?timestamp=1705988524&nonce=55df3f9f7311a9acd91bf074cd524092&sign=z43nMSO1L2HBvoqADLkRxr7Biz0fkjeDstnJiCK1zh8=",
