...
public class WorkflowAggregate extends TableImpl<WorkflowAggregateRecord> {
     ...
     */
    public final TableField<WorkflowAggregateRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this,
            "workflow配置自增主键");
    /**
     * The column <code>workflow_aggregate.tenant_id</code>. 租户id
     */
    public final TableField<WorkflowAggregateRecord, String> TENANT_ID = createField(DSL.name("tenant_id"), SQLDataType.VARCHAR(64).nullable(false),
            this, "租户id");
    /**
     * The column <code>workflow_aggregate.workflow_id</code>.
     */
    public final TableField<WorkflowAggregateRecord, String> WORKFLOW_ID = createField(DSL.name("workflow_id"),
            SQLDataType.VARCHAR(128).nullable(false), this, "");
    /**
     * The column <code>workflow_aggregate.title</code>.
     */
    public final TableField<WorkflowAggregateRecord, String> TITLE = createField(DSL.name("title"),
     ...
     */
    public final TableField<WorkflowAggregateRecord, String> DESC = createField(DSL.name("desc"),
            SQLDataType.VARCHAR(1024).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");
    /**
     * The column <code>workflow_aggregate.graph</code>. 工作流DAG配置
     */
    public final TableField<WorkflowAggregateRecord, String> GRAPH = createField(DSL.name("graph"), SQLDataType.CLOB.nullable(false), this,
            "工作流DAG配置");
    /**
     * The column <code>workflow_aggregate.version</code>. 工作流版本，0: draft, &gt;0
     * 正式版时间戳
     */
    public final TableField<WorkflowAggregateRecord, Long> VERSION = createField(DSL.name("version"),
            SQLDataType.BIGINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.BIGINT)), this, "工作流版本，0: draft, >0 正式版时间戳");
    /**
     * The column <code>workflow_aggregate.latest_publish_version</code>.
     * 工作流最新发布版本，0: draft, &gt;0 正式版时间戳
     */
    public final TableField<WorkflowAggregateRecord, Long> LATEST_PUBLISH_VERSION = createField(DSL.name("latest_publish_version"),
            SQLDataType.BIGINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.BIGINT)), this, "工作流最新发布版本，0: draft, >0 正式版时间戳");
    /**
     * The column <code>workflow_aggregate.cuid</code>.
     */
    public final TableField<WorkflowAggregateRecord, Long> CUID = createField(DSL.name("cuid"),
     ...
     */
    public final TableField<WorkflowAggregateRecord, String> CU_NAME = createField(DSL.name("cu_name"),
     ...
     */
    public final TableField<WorkflowAggregateRecord, LocalDateTime> CTIME = createField(DSL.name("ctime"),
     ...
     */
    public final TableField<WorkflowAggregateRecord, Long> MUID = createField(DSL.name("muid"),
            SQLDataType.BIGINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.BIGINT)), this, "");
    /**
     * The column <code>workflow_aggregate.mu_name</code>.
     */
    public final TableField<WorkflowAggregateRecord, String> MU_NAME = createField(DSL.name("mu_name"),
            SQLDataType.VARCHAR(32).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");
    /**
     * The column <code>workflow_aggregate.mtime</code>.
     */
    public final TableField<WorkflowAggregateRecord, LocalDateTime> MTIME = createField(DSL.name("mtime"),
            SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.LOCALDATETIME)), this, "");
