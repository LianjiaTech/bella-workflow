...
public class Tenant extends TableImpl<TenantRecord> {
    ...
    /**
     * The column <code>tenant.openapi_key</code>.
     */
    public final TableField<TenantRecord, String> OPENAPI_KEY = createField(DSL.name("openapi_key"), SQLDataType.VARCHAR(64).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "");
