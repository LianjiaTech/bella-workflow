      ...
      <div className='flex justify-between gap-1'>
        ...
        {!expanded && (
          <div className='flex gap-1'>
            {fullList.map((file) => {
              const { _id, filename, type, supportFileType, base64Url, url } = file
                ...
                <>
                  ...
                  {!isImageFile && (
                    <Tooltip
                      popupContent={filename}
                    >
                      <div key={_id} className='p-1.5 rounded-md bg-components-panel-on-panel-item-bg border-[0.5px] border-components-panel-border shadow-xs'>
                        <FileTypeIcon
