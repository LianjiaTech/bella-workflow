...
public class RagNodeTest {
    ...
    public void testRagNode() throws IOException {
        ...
        WorkflowContext context = CommonNodeTest.createContext("src/test/resources/rag_node_test.json", map);
        new WorkflowRunner().run(context, new WorkflowCallbackAdaptor() {
            ...
            public void onWorkflowNodeRunSucceeded(WorkflowContext context, String nodeId, String nodeRunId) {
                if("1728362199362".equals(nodeId)) {
                    ...
                    List<KnowledgeRetrievalNode.KnowledgeRetrievalResult> resultList = (List) result.getOutputs().get("contents");
